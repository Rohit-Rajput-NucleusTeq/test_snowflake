...
# COMMAND ----------
# DBTITLE 1, EXP_INT_CONVERSION_2 [Expression] 
...
df_2_1.createOrReplaceTempView("EXP_INT_CONVERSION_2")

query_2_2 = f"""SELECT
  *,
  TO_INTEGER(DC_NBR) AS o_DC_NBR
FROM
  EXP_INT_CONVERSION_2"""

df_2_2 = spark.sql(query_2_2)

df_2_2.createOrReplaceTempView("EXP_INT_CONVERSION_2")
...
# COMMAND ----------
# DBTITLE 1, EXP_UPD_VALIDATOR_10 [Expression] 
...
df_10_1.createOrReplaceTempView("EXP_UPD_VALIDATOR_10")
...
df_10_2.createOrReplaceTempView("EXP_UPD_VALIDATOR_10")
